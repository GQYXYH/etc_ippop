...
from custom_envs.multiwalker_communicate.multiwalker_c.multiwalker_pri import FPS
from custom_envs.multiwalker_communicate.multiwalker_c.multiwalker_pri import MultiWalkerEnv as _env
