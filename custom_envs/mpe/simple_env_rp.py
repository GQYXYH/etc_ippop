...
class SimpleEnv(AECEnv):
    ...
    def observe(self, agent):
        ...
        return self.scenario.observation(
            self.world.agents[self._index_map[agent]], self.world, self.steps,self.current_comm_index
        ).astype(np.float32)
        # note change index according to L_1
