...
def get_config():
    ...
    parser.add_argument("--com_ratio", type=float, default=0.001, help="Ratio for agent communication penalty,0.05 default for multiwalker,0.1 for simple spread")
    # multiwalker 0.05, spread 0.01
    parser.add_argument("--local_ratio", type=float, default=0.4, help="Ratio for agent rewards")
    ...
    parser.add_argument("--entropy_coef", type=float, default=0.015,
                        help='entropy term coefficient (default: 0.015)')
    # multiwalker 0.015, spread 0.03?

    parser.add_argument("--entropyppo_coef", type=float, default=0.015)
