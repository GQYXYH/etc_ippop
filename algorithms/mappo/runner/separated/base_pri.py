...
class Runner(object):
    def __init__(self, config):
        ...
        from algorithms.mappo.algorithms.r_mappo.r_mappo_pri import R_MAPPO as TrainAlgo
        print("r_mappo_pri")
        from algorithms.mappo.algorithms.r_mappo.algorithm.rMAPPOPolicy_dpo_nopen import R_MAPPOPolicy as Policy
        print("rMAPPOPolicy_dpo_nopen")
